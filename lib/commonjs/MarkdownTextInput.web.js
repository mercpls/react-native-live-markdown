...
var _parserUtils = require("./web/utils/parserUtils");
var _InputHistory = _interopRequireDefault(require("./web/InputHistory"));
var _cursorUtils = require("./web/utils/cursorUtils");
require("./web/MarkdownTextInput.css");
var _inputUtils = require("./web/utils/inputUtils");
var _webStyleUtils = require("./web/utils/webStyleUtils");
var _inlineImage = require("./web/inputElements/inlineImage");
...
const MarkdownTextInput = /*#__PURE__*/_react.default.forwardRef(({
  ...
  const parseText = (0, _react.useCallback)((target, text, customMarkdownStyles, cursorPosition = null, shouldAddToHistory = true, shouldForceDOMUpdate = false, shouldScrollIntoView = false) => {
    if (!divRef.current) {
      return {
        text: text || '',
        cursorPosition: null
    ...
    const parsedText = (0, _parserUtils.updateInputStructure)(target, text, cursorPosition, multiline, customMarkdownStyles, false, shouldForceDOMUpdate, shouldScrollIntoView, {
      addAuthTokenToImageURLCallback,
      imagePreviewAuthRequiredURLs
    });
  ...
  }, disabled && styles.disabledInputStyles, (0, _webStyleUtils.parseToReactDOMStyle)(flattenedStyle)]), [flattenedStyle, multiline, disabled]);
  ...
  const handleOnSelect = (0, _react.useCallback)(e => {
    ...
    if (divRef.current && contentSelection.current && hasJustBeenFocused.current) {
      ...
      (0, _cursorUtils.setCursorPosition)(divRef.current, (_contentSelection$cur = contentSelection.current) === null || _contentSelection$cur === void 0 ? void 0 : _contentSelection$cur.start, (_contentSelection$cur2 = contentSelection.current) === null || _contentSelection$cur2 === void 0 ? void 0 : _contentSelection$cur2.end, true);
  ...
  const handleOnChangeText = (0, _react.useCallback)(e => {
    ...
    let parsedText = (0, _inputUtils.normalizeValue)(inputType === 'pasteText' ? pasteContent.current || '' : (0, _inputUtils.parseInnerHTMLToText)(e.target, contentSelection.current.start, inputType));
